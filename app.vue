...
#flash_layout .spinner {
  color: #BB8D31;
  font-size: 40px;
  -webkit-animation: putar 1s infinite;
          animation: putar 1s infinite;
}
...
#navbar .container .sidebarToggle {
  color: #fff !important;
  position: relative;
  font-size: 28px;
  z-index: 100;
...
#navbar .container .sidebarToggle:active {
...
#navbar .container .navs li a {
  color: #ffffff;
  opacity: .75;
}

#navbar .container .navs li a:hover {
  opacity: 1;
}

#navbar .container .navs li.active a {
  opacity: 1;
  font-weight: bold;
  color: #BB8D31 !important;
}
...
#header .inner-header .socmed li {
  padding: 1.5rem;
}

#header .inner-header .socmed li a {
  color: #BB8D31;
  font-size: 23px;
}
...
#about::after {
  ...
  bottom: 0;
  left: 50%;
  background-image: url("../images/MeInBlack.png");
...
#services {
  ...
  height: fit-content;
  background-image: url("../images/725868.jpg");
  background-color: #000000;
  background-size: cover;
  background-position: center center;
}
...
#services .container {
  background-color: rgba(126, 97, 39, 0.5);
  height: inherit;
  text-align: center;
  padding-top: 5rem;
  padding-bottom: 5rem;
...
#services .container .items .item .icon {
  color: #BB8D31;
  font-size: 40px;
}

#services .container .items .item .name {
  color: #fff;
  font-weight: bold;
  margin-top: 1rem;
}
...
#portfolio .container .items .item .image {
  ...
  border: 2px solid rgba(187, 141, 49, 1);
  overflow: hidden;
  border-radius: 6px;
  box-sizing: border-box;
}

#portfolio .container .items .item .image img{
  width: 100%;
  height: 100%;
  object-fit: cover;
...
#portfolio .container .items .item .text .btn {
  margin-top: 2rem;
}

#portfolio .container .items .item:nth-child(even) {
      grid-template-areas: 'info img';
}

#portfolio .container .devider {
  height: 0;
...
#order .container .steps .line {
  ...
  -webkit-transform: translateX(-50%) translateY(-50%);
          transform: translateX(-50%) translateY(-50%);
  position: absolute;
  border-bottom: 3px solid #BB8D31;
}

#order .container .steps .step .circle {
  width: 100px;
  margin: auto;
  display: -webkit-box;
  display: -ms-flexbox;
  ...
  position: relative;
  z-index: 98;
  border: 3px solid #BB8D31;
  border-radius: 50%;
}

#order .container .steps .step .desc {
  margin-top: 1.5rem;
}
...
#contact .container .items .item .icon {
  font-size: 40px;
  color: #BB8D31;
}
...
#contact .container .items .item .desc {
  opacity: .75;
  margin-top: .5rem;
}
...
#cta {
  padding: 6rem 5%;
  text-align: center;
  background: -webkit-gradient(linear, left bottom, left top, from(#231A07), to(#000000));
  background: linear-gradient(0deg, #231A07 0%, #000000 100%);
}
...
@media (max-width: 850px) {
  ...
  #navbar.showSidebar .container .navs {
    top: 0;
  }
  #navbar.scroll {
